        ...
        async function submitExport(type) {
            try {
                ...
                if (type === 'pdf') {
                    ...
                    doc.setFontSize(16);
                    doc.text(`Call Logs Report - ${siteName}`, 105, 50, {
                        align: 'center'
                    });
