...
<div
    ...
    <div style="flex: 1; max-width: 50%;">
        <canvas id="bookingsChart2_{{ Str::slug($project_name, '_') }}" style="width: 100%; max-height: 400px;"></canvas>
    ...
    <div style="flex: 1; max-width: 40%;">
        ...
        <thead>
            <tr style="background-color: #8b5a3b; color: #fff;">
                ...
                <th style="padding: 6px 8px; border: 1px solid #ddd;">Contracts</th>
            </tr>
        </thead>
        <tbody>
...
<script>
    let ctx2_{{ Str::slug($project_name, '_') }} = document.getElementById('bookingsChart2_{{ Str::slug($project_name, '_') }}').getContext('2d');
