                ...
                <table
                    ...
                    <thead>
                        <tr style="background-color: #8b5a3b; color: white;">
                            <th rowspan="2" style="padding: 8px; border: 1px solid #ccc;">المرحلة</th>
                            <th rowspan="2" style="padding: 8px; border: 1px solid #ccc;">عدد الوحدات لكل مرحلة</th>
                            <th colspan="2" style="padding: 8px; border: 1px solid #ccc;">المحجوز</th>
                            <th colspan="2" style="padding: 8px; border: 1px solid #ccc;">المتعاقد</th>
                            <th colspan="2" style="padding: 8px; border: 1px solid #ccc;">المتاح</th>
                            <th colspan="2" style="padding: 8px; border: 1px solid #ccc;">المحجوب</th>
                        </tr>
                        <tr style="background-color: #8b5a3b; color: white;">
                            <th style="padding: 6px; border: 1px solid #ccc;">مستفيد</th>
                            <th style="padding: 6px; border: 1px solid #ccc;">غير مستفيد</th>
                            <th style="padding: 6px; border: 1px solid #ccc;">مستفيد</th>
                            <th style="padding: 6px; border: 1px solid #ccc;">غير مستفيد</th>
                            <th style="padding: 6px; border: 1px solid #ccc;">مستفيد</th>
                            <th style="padding: 6px; border: 1px solid #ccc;">غير مستفيد</th>
