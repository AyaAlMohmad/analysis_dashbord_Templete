<div style="background-color: #f9f6f2; padding: 60px 20px; font-family: 'Arial', sans-serif; direction: rtl; position: relative;">
    ...
    <div style="display: flex; gap: 20px; flex-direction: row-reverse; justify-content: space-between; align-items: flex-start;">
        ...
        <div style="flex: 1; max-width: 100%; overflow-x: auto; display: flex; justify-content: center;">
            <table style="width: 100%; max-width: 800px; border-collapse: collapse; font-size: 13px; font-family: 'Arial', sans-serif; text-align: center; background-color: #fff; margin: auto;">
                <thead>
                    <tr style="background-color: #8b5a3b; color: white;">
                        ...
                        <th colspan="2" style="padding: 8px; border: 1px solid #ccc;">{{ __('components.blocked') }}</th>
                    </tr>
                    <tr style="background-color: #8b5a3b; color: white;">
                ...
                <tbody>
                    @foreach($statusData['groups'] as $group)
                        ...
                        <tr style="background-color: {{ $loop->odd ? '#f9f9f9' : '#ffffff' }};">
                            ...
                            <td style="border: 1px solid #ccc;">{{ $blocked['beneficiary'] ?? 0 }}</td>
                            <td style="border: 1px solid #ccc;">{{ $blocked['non_beneficiary'] ?? 0 }}</td>
                        </tr>
                    @endforeach
                </tbody>
