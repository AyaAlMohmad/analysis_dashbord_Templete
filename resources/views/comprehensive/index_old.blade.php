...
<div id="report-content">
        ...
        <div class="khozam-section" style="background-color: #f9f6f2; padding: 60px 20px; direction: rtl; position: relative; display: flex; align-items: center; justify-content: space-between; font-family: 'Arial', sans-serif; flex-wrap: wrap;">
            ...
            <div style="flex: 2; text-align: center; padding: 20px; max-width: 100%;">
                <div style="margin-bottom: 30px;">
                    <img src="{{ asset('images/logo1.png') }}" alt="Project Logo" style="height:200px;">
                </div>
                <div style="margin-top: 20px; font-size: 18px; color: #8b5a3b;">
                    من 2025-03-21 الى 2025-03-28
                </div>
            </div>
    ...
    <!-- الأقسام المضمنة مع فواصل صفحات -->
    <div class="page-section">@include('comprehensive.colored_map')</div>
    <div class="page-section">@include('comprehensive.reserved_report')</div>
    <div class="page-section">@include('comprehensive.contracts_report')</div>
    <div class="page-section">@include('comprehensive.status_item')</div>
    <div class="page-section">@include('comprehensive.unitStages')</div>
    <div class="page-section">@include('comprehensive.unitStatisticsByStage')</div>
