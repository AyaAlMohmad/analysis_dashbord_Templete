...
<div id="report-content">
    ...
    <div class="project-section" style="margin-bottom: 50px;">
        {{-- <h2 style="text-align: center; color: #8b5a3b; margin-bottom: 30px;">مشروع أزيان الظهران</h2> --}}
        <div class="page-section">@include('comprehensive.colored_map', ['data' => $dhahranData,'project_name' => 'أزيان الظهران' ])</div>
        <div class="page-section">@include('comprehensive.reserved_report', ['data' => $dhahranData,'project_name' => 'أزيان الظهران'])</div>
        <div class="page-section">@include('comprehensive.contracts_report', ['data' => $dhahranDataContract,'project_name' => 'أزيان الظهران'])</div>
        <div class="page-section">@include('comprehensive.status_item', ['statusData' => $dhahranStatusData ,'project_name' => 'أزيان الظهران'])</div>
        <div class="page-section">@include('comprehensive.unitStages', ['unitStages' => $dhahranUnitStages,'project_name' => 'أزيان الظهران'])</div>
        <div class="page-section">@include('comprehensive.unitStatisticsByStage', ['unitStats' => $dhahranUnitStatisticsByStage,'project_name' => 'أزيان الظهران'])</div>
    </div>
    <div class="page-section">
        <div class="khozam-section" style="background-color: #f9f6f2; padding: 60px 20px; direction: rtl; position: relative; display: flex; align-items: center; justify-content: space-between; font-family: 'Arial', sans-serif; flex-wrap: wrap;">
            <div style="position: absolute; top: 30px; right: 30px;">
    ...
    <div class="project-section" style="margin-bottom: 50px;">
        ...
        <div class="page-section">@include('comprehensive.colored_map', ['data' => $albashaerData,'project_name' => 'أزيان البشائر'])</div>
        <div class="page-section">@include('comprehensive.reserved_report', ['data' => $albashaerData, 'project_name' => 'أزيان البشائر'])</div>
        <div class="page-section">@include('comprehensive.contracts_report', ['data' => $albashaerDataContract,'project_name' => 'أزيان البشائر'])</div>
        <div class="page-section">@include('comprehensive.status_item', ['statusData' => $bashaerStatusData,'project_name' => 'أزيان البشائر'])</div>
        <div class="page-section">@include('comprehensive.unitStages', ['unitStages' => $albashaerUnitStages,'project_name' => 'أزيان البشائر'])</div>
        <div class="page-section">@include('comprehensive.unitStatisticsByStage', ['unitStats' => $albashaerUnitStatisticsByStage,'project_name' => 'أزيان البشائر'])</div>
    </div>

    <!-- الأقسام المشتركة -->
    <div class="page-section">@include('comprehensive.unit_sales')</div>
    <div class="page-section">@include('comprehensive.visits_payments_contracts')</div>
    <div class="page-section">@include('comprehensive.source_stats')</div>
    <div class="page-section">@include('comprehensive.disinterest_reasons')</div>
    <div class="page-section">@include('comprehensive.monthly_appointments')</div>
    <div class="page-section">@include('comprehensive.targeted_report')</div>
